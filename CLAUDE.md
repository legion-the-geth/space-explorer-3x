...
- **Contexte explicite** : utiliser @fichier plutôt que copier du code
...
5. **📝 Fin de session**
   ...
   - Mise à jour CLAUDE.md si nouveaux patterns/décisions
   - Mise à jour TODO.md (cocher fait, ajouter découvertes)
   - Gestion Git :
     * Si feature complète : commit + push + proposer merge/PR
     * Si en cours : commit + push sur branche feature
     * Si expérimental : proposer de stash ou créer branche dédiée
...
- **CLAUDE.md** : Ce fichier, à enrichir avec nouvelles décisions d'archi
...
**Feedback** : ✅ Correction appliquée, grille fonctionne parfaitement
